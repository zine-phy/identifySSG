...
# def smith_form_sage(M):
#     n1,n2 = M.shape
#     sparse = n1>100 or n2>100
#     M_ = sage.MatrixSpace(sage.IntegerModRing(0), n1, n2, sparse=sparse)(M)
#     Lmd_,L_,R_ = M_.smith_form()
#     LI_ = L_.inverse()
#     RI_ = R_.inverse()
